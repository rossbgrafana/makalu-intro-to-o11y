...
Example:  Think of using `ssh` to connect to a remote system and running the `top` command to see system information, such as you see in the figure below.

<img align="center" width="300" height="200" src="https://github.com/rossbgrafana/makalu-intro-to-o11y/blob/main/s01-images/01-02-A_ssh-running-top.png?raw=true">

**Running the top command via ssh**
